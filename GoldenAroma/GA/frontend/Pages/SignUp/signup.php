...
<div class="rectangleSignUp">
    ...
    <hr class="line2">
    <input type="text" class="firstName" placeholder="First Name" style="text-indent: 30px">
    <input type="text" class="lastName" placeholder="Last Name" style="text-indent: 30px">
    <input type="text" class="emailSignUp" placeholder="Email" style="text-indent: 30px">
    <input type="password" class="pwdSignUp" placeholder="Password" style="text-indent: 30px">
    <input type="password" class="pwdConfirm" placeholder="Confirm Password" style="text-indent: 30px">
